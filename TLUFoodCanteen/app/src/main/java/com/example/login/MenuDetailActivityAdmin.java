...
public class MenuDetailActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_detail_admin);
        ...
        btnUpdate.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(MenuDetailActivityAdmin.this, UpdateMenuActivityAdmin.class);
    ...
    private void loadDetail() {
        menuRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MenuDetailActivityAdmin.this, "Lỗi khi tải chi tiết", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
