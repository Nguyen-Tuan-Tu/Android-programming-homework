...
public class MenuActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_add_menu).setOnClickListener(v -> {
            ...
            Intent intent = new Intent(MenuActivityAdmin.this, AddMenuActivityAdmin.class);
    ...
    private void loadMenuData() {
        menuRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                // Xử lý lỗi nếu có
                Toast.makeText(MenuActivityAdmin.this, "Lỗi khi tải thực đơn!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
