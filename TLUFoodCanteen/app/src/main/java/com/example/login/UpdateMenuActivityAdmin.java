...
public class UpdateMenuActivityAdmin extends AppCompatActivity {
                                ...
                                .addOnSuccessListener(aVoid1 -> {
                                    ...
                                    menuRef.child("notes").setValue(updatedNotes.split(","))
                                            .addOnSuccessListener(aVoid2 -> {
                                                // Cập nhật thành công
                                                Toast.makeText(UpdateMenuActivityAdmin.this, "Cập nhật thực đơn thành công!", Toast.LENGTH_SHORT).show();
                                                finish();
                                            })
                                            .addOnFailureListener(e -> {
                                                Toast.makeText(UpdateMenuActivityAdmin.this, "Lỗi khi cập nhật ghi chú: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                            });
                                })
                                .addOnFailureListener(e -> {
                                    Toast.makeText(UpdateMenuActivityAdmin.this, "Lỗi khi cập nhật món ăn: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(UpdateMenuActivityAdmin.this, "Lỗi khi cập nhật tên thực đơn: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        });
    }
}
