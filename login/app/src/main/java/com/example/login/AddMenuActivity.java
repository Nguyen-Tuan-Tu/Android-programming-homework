    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foodRef.addValueEventListener(new com.google.firebase.database.ValueEventListener() {
            ...
            public void onDataChange(com.google.firebase.database.DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(AddMenuActivity.this, android.R.layout.simple_dropdown_item_1line, foodList);
            ...
            public void onCancelled(com.google.firebase.database.DatabaseError databaseError) {
                Toast.makeText(AddMenuActivity.this, "Lỗi khi tải danh sách món ăn!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnAddMenu.setOnClickListener(v -> {
            ...
            if (menuName.isEmpty() || selectedFoods.isEmpty()) {
                Toast.makeText(AddMenuActivity.this, "Vui lòng nhập tên thực đơn và chọn món ăn.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            menuRef.child(selectedDayKey).setValue(newMenu)
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(AddMenuActivity.this, "Thêm thực đơn cho " + spinnerDays.getSelectedItem().toString() + " thành công!", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(AddMenuActivity.this, MenuActivity.class);
                        startActivity(intent);
                        finish();
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(AddMenuActivity.this, "Lỗi khi thêm thực đơn: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        });
    }
