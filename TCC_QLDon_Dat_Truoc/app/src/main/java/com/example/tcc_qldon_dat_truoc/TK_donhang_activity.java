...
public class TK_donhang_activity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Đặt layout cho activity bằng cách sử dụng setContentView
        setContentView(R.layout.activity_tk_donhang);  // Trỏ đến file XML tương ứng
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TK_donhang_activity.this,   MainActivity.class);
