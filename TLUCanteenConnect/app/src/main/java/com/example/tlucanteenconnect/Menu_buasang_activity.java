...
public class Menu_buasang_activity extends AppCompatActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        // Gán layout cho activity này
        setContentView(R.layout.activity_menu_buasang);  // Đảm bảo rằng bạn đã tạo layout activity_menu_buasang.xml
        ...
        txtDrink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Menu_buasang_activity.this, Menu_douong_activity.class);
        ...
        txtRecomment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Menu_buasang_activity.this, Menu_dexuat_activity.class);
                startActivity(intent);  // Chạy Activity mới
            }
        });
    }
